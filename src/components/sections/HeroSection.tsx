...
import { Check, Gamepad2, Users, Zap, BadgeInfo } from "lucide-react";

import Background from "@/assets/background.webp";
import Osmimum from "@/assets/osmium.webp";
...
export default function Home() {
  ...
  const features = [
    ...
    { icon: BadgeInfo, label: "Version 1.21.1", color: "text-purple-400", delay: 0.5 },
  ];
        ...
        <div className="relative z-10 flex py-6 items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
          <div className="w-full max-w-6xl mx-auto text-center text-white">
            ...
            >
              ...
              {/* Description */}
              <p className="text-sm sm:text-base md:text-lg max-w-3xl mx-auto text-gray-200 leading-relaxed text-center">
            ...
            >
              {features.map((feature) => (
                <m.div
                  ...
                  hover:bg-white/10 transition-all duration-300 w-full sm:w-1/2 md:w-1/3 lg:w-1/5 flex flex-col items-center text-center"
                >
                  <feature.icon
                    size={28}
